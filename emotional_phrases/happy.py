phrases = [
    ...
    "Yay! I found a new coffee place that’s amazing!",
    ...
    "Woohoo! I caught the bus just before it left!",
    ...
    "Yay!  The project I worked on was approved without changes!",
    "I found a parking spot right in front of the store!",
    "I was able to reunite with an old friend today!",
    "Great! I tried a new recipe and it turned out delicious!",
    ...
    "Hooray! I had the best coffee of my life this morning!",
    ...
    "Hooray! I remembered all the lyrics to my favorite song!",
    ...
    "Yippee! I went for a walk and it was so relaxing!",
    ...
    "Yay! I made someone laugh at work today!",
    "Woohoo! My favorite shirt still fits me perfectly!",
